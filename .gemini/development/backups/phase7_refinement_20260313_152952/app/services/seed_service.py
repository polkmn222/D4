...
class SeedService:
    ...
    async def generate_theme_data(db: Session, theme: str, count: int = 5):
        ...
        2. "products": list of (name: Car Model like 'Zenith S1', brand, category: 'EV', 'SUV', 'Sedan', base_price: integer)
        3. "accounts": list of (name, industry: 'Automotive', record_type: 'Individual' or 'Corporate', tier: 'Bronze', 'Silver', 'Gold')
