...
async def campaign_detail(request: Request, campaign_id: str, db: Session = Depends(get_db)):
    try:
        ...
        return templates.TemplateResponse("campaigns/detail_view.html", {
...
async def list_campaigns(request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("campaigns/list_view.html", {
        "request": request, 
...
async def update_campaign(
    ...
    CampaignService.update_campaign(
        db, campaign_id, name=name, type=type, status=status, description=description
    )
