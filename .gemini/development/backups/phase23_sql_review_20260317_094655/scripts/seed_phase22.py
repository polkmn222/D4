...
def seed_data():
    ...
    companies = ["GK Motors", "Galaxy Tech", "Quantum Systems", "Aurora Industries", "Pioneer Group"]
    ...
    print("Seeding 10 Accounts for Phase 22...")
    accounts = []
    for i in range(10):
        acc = Account(
            id=get_id("Account"),
            name=f"{random.choice(companies)} {chr(65+i)}",
    ...
    for i in range(10):
        ...
        opp = Opportunity(
            ...
            account_id=acc.id,
            name=f"Project {random.choice(['Alpha', 'Beta', 'Gamma', 'Delta'])} - {acc.name}",
    ...
    db.commit()
    print("Phase 22 Seeding complete.")
