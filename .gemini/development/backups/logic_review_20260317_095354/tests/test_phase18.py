...
def test_opportunity_stage_and_dates(db):
    ...
    acc = AccountService.create_account(db, name="Test Acc")
    
    # Create Opp
    opp = OpportunityService.create_opportunity(db, account_id=acc.id, name="Test Opp", amount=1000, stage="Prospecting")
