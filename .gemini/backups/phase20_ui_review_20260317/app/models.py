...
class VehicleSpecification(BaseModel):
    ...
    parent = Column("parent_id", String(18), ForeignKey("vehicle_specifications.id"), nullable=True)
...
class Model(BaseModel):
    ...
    id = Column(String(18), primary_key=True, index=True)
    name = Column(String, nullable=True)
    brand = Column("brand_id", String(18), ForeignKey("vehicle_specifications.id"), nullable=True)
    description = Column(Text, nullable=True)
...
class Contact(BaseModel):
    ...
    id = Column(String(18), primary_key=True, index=True)
    account = Column("account_id", String(18), ForeignKey("accounts.id"), nullable=True)
...
class Lead(BaseModel):
    ...
    converted_account = Column("converted_account_id", String(18), ForeignKey("accounts.id"), nullable=True)
    converted_opportunity = Column("converted_opportunity_id", String(18), ForeignKey("opportunities.id"), nullable=True)
    campaign = Column("campaign_id", String(18), ForeignKey("campaigns.id"), nullable=True)
    brand = Column("brand_id", String(18), ForeignKey("vehicle_specifications.id"), nullable=True)
    model = Column("model_id", String(18), ForeignKey("models.id"), nullable=True)
    product = Column("product_id", String(18), ForeignKey("products.id"), nullable=True)
    description = Column(Text, nullable=True)
...
class Opportunity(BaseModel):
    ...
    account = Column("account_id", String(18), ForeignKey("accounts.id"), nullable=True)
    product = Column("product_id", String(18), ForeignKey("products.id"), nullable=True)
    lead = Column("lead_id", String(18), ForeignKey("leads.id"), nullable=True)
    brand = Column("brand_id", String(18), ForeignKey("vehicle_specifications.id"), nullable=True)
    model = Column("model_id", String(18), ForeignKey("models.id"), nullable=True)
    asset = Column("asset_id", String(18), ForeignKey("assets.id"), nullable=True)
    name = Column(String, nullable=True)
...
class Task(BaseModel):
    ...
    id = Column(String(18), primary_key=True, index=True)
    account = Column("account_id", String(18), ForeignKey("accounts.id"), nullable=True)
    opportunity = Column("opportunity_id", String(18), ForeignKey("opportunities.id"), nullable=True)
    ...
    message = Column("message_id", String(18), ForeignKey("messages.id"), nullable=True)

class Message(BaseModel):
    __tablename__ = "messages"

    id = Column(String(18), primary_key=True, index=True)
    contact = Column("contact_id", String(18), ForeignKey("contacts.id"), nullable=True)
    account = Column("account_id", String(18), ForeignKey("accounts.id"), nullable=True)
    template = Column("template_id", String(18), ForeignKey("message_templates.id"), nullable=True)
