        ...
        updatePreview() {
            ...
            if (content || mmsCard.style.display !== 'none') {
                ...
                if (content) {
                    ...
                    // If image exists, make bottom of image flat to join with bubble
                    if (mmsCard.style.display !== 'none') {
                        document.getElementById('preview-mms-display').style.borderRadius = '15px 15px 0 0';
                        bubble.style.borderRadius = '0 0 18px 18px';
                    } else {
