...
- AI runtime notes live in `/development/docs/agent.md`.
...
- AI backend tests live under `/development/test/unit/ai_agent/backend/`.
- AI frontend/runtime tests live under `/development/test/unit/ai_agent/frontend/`.
- Manual AI assets live under `/development/test/manual/ai_agent/`.
