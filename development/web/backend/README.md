...
- Deployment behavior lives in `/development/docs/deployment.md`.
- Workflow and backup rules live in `/development/docs/workflow.md`.
...
- Core backend unit tests live under `/development/test/unit/`.
- Integration tests live under `/development/test/integration/`.
