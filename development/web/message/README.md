...
- Primary rules live in `/development/docs/skill.md`.
- Runtime structure lives in `/development/docs/architecture.md`.
- Messaging and deployment behavior lives in `/development/docs/agent.md` and `/development/docs/deployment.md`.
- Testing rules live in `/development/docs/testing/`.
...
- Messaging unit tests live under `/development/test/unit/messaging/`.
- Shared UI tests that touch messaging templates live under `/development/test/unit/ui/shared/`.
