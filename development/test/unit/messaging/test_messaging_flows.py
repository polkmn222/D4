...
from db.models import MessageSend, Contact, Opportunity, Model, MessageTemplate, Attachment
...
def test_send_mms_with_attachment_mock_provider(db):
    contact = ContactService.create_contact(db, first_name="MMS", last_name="User", phone="010-3333-4444")
    attachment = AttachmentService.create_attachment(
        db,
        name="phase190-test.jpg",
        file_path="/static/uploads/message_templates/25f73140-29e2-4749-b980-829b00b62ae9.jpg",
        content_type="image/jpeg",
        file_size=69234,
        parent_type="TestMessageFlow",
        provider_key="",
    )
