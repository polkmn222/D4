...
from web.backend.app.core.enums import RecordType, ContactTier, LeadStatus, OpportunityStage, OpportunityStatus, MessageDirection, MessageStatus
...
class LeadListView(BaseModel):
    __tablename__ = "lead_list_views"

    id = Column(String(18), primary_key=True, index=True)
    owner_key = Column(String, nullable=False, default="default")
    object_type = Column(String, nullable=False, default="Lead")
    label = Column(String, nullable=False)
    source = Column(String, nullable=False, default="all")
    visible_columns_json = Column(Text, nullable=False, default="[]")
