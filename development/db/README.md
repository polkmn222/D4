...
- Deployment and environment expectations live in `/development/docs/deployment.md`.
...
- Model and database-adjacent tests appear across `/development/test/unit/`.
- Manual test setup helpers live under `/development/test/manual/data_setup/`.
